...
(function ($) {
    ...
    function DataEngine(vName, columns) {
        ...
        function loadPage(columnOrder, data, url) {
            dashboardColumns = {};
                ...
                */
                ...
                $(document).ready(function () {
                    ...
                    $(".side-panel-config-clear").on("click", function (event) {
                        clearAllColumnSelects("div.side-panel-div select", "");
                        dTable
                         .search('')
                         .columns().search('')
                         .draw();
                    ...
                    $(".side-panel-config-close").on("click", function (event) {
                        setAllColumnSelectsSize("div.side-panel-div select", 1);
                    })

                    $("#OpenAllSidePanelFilters").on("click", function (event) {
                        setAllColumnSelectsSize("div.side-panel-div select", 6);
                    })
         ...
         */
        function callHttpMethod(path, httpMethod, jsonData, successMethod, successMethodParams, errorMethod) {
            try {
                if (httpMethod == "GET") {
                    var restPath = path;
        ...
        function clearAllColumnSelects(selector, defaultValue) {
            var selector = $(selector); //.multiselect("uncheckAll");
            selector.val("")
        }

        function setAllColumnSelectsSize(selector, size) {
        ...
        function getProjectsError(error) {
